module github.com/tinyverse-web3/neutrino
...
require (
	...
	github.com/tinyverse-web3/btcwallet/wallet/txrules v1.2.0 // indirect
	github.com/tinyverse-web3/btcwallet/wallet/txsizes v1.2.3 // indirect
